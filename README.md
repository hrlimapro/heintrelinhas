# 🚀 EnterLinhas — Plataforma de Publicação Literária e Artigos

O **EnterLinhas** é uma aplicação web completa (Full Stack) para publicação, gerenciamento e leitura de posts e artigos. A plataforma conta com diferentes níveis de acesso (Escritores, Editores e Administradores) e um design moderno com tema escuro e efeitos em neon.
...
*   **[`backend/`](file:///c:/Users/Henrique/Desktop/EnterLinhas/backend)**: Servidor de API construído com **Fastify**, **TypeScript**, **Zod** para validação e **Prisma ORM** integrado com banco de dados **PostgreSQL**.
*   **[`frontend/`](file:///c:/Users/Henrique/Desktop/EnterLinhas/frontend)**: Aplicativo do lado do cliente construído com **React**, **Vite**, **React Router**, **Axios** e estilizado com **Vanilla CSS** moderno (variáveis HSL customizadas).
...
2. Crie um banco de dados chamado `enterlinhas_db`.
3. Abra o arquivo [`backend/.env`](file:///c:/Users/Henrique/Desktop/EnterLinhas/backend/.env) e ajuste a variável `DATABASE_URL` com o seu usuário e senha local do PostgreSQL. Exemplo:
   ```env
   DATABASE_URL="postgresql://seu_usuario:sua_senha@localhost:5432/enterlinhas_db?schema=public"
   ```
...
| :--- | :--- | :--- | :--- |
| **ADMIN** | `admin@enterlinhas.com` | `admin123` | Acesso total, gerenciamento de posts, categorias e tags. |
| **EDITOR** | `editor@enterlinhas.com` | `editor123` | Revisar posts pendentes e gerenciar tags/categorias. |
| **WRITER** | `writer@enterlinhas.com` | `writer123` | Criar e editar seus próprios posts (salvar como rascunho ou enviar para revisão). |
